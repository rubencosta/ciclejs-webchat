...
run(main, {
  ...
  initialModel: () => Rx.Observable.just({
      chats: [{
        id: 1, user: {
          id: 2, profilePicture: "https://avatars0.githubusercontent.com/u/7922109?:3&:460", name: "Ryan Clark"
        }, messages: [{
        ...
        {
          id: 2, user: {
          id: 3, profilePicture: "https://avatars3.githubusercontent.com/u/2955483?:3&:460", name: "Jilles Soeters"
        },
          messages: [{
        ...
        {
          id: 3, user: {
          id: 4, profilePicture: "https://avatars1.githubusercontent.com/u/1655968?:3&:460", name: "JTodd Motto"
        },
          messages: [{
